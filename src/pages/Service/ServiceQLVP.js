...
import image10 from '../../assets/img/dichVu/IMAGE10.jpg';
import image11 from '../../assets/img/dichVu/IMAGE11.jpg';
import image12 from '../../assets/img/dichVu/IMAGE12.png';

const serviceQLVP = () => {
	return (
		<>
			<Container>
				<Box className='quan-ly-van-phong'>
					<Grid container spacing={4}>
						<Grid item md={9}>
							...
							<Typography>
								Khách thuê là đối tượng được phục vụ hàng ngày của Tòa nhà, vì
								vậy việc họ hài lòng, kinh doanh phát triển, tiếp tục thuê tại
								tòa nhà là rất quan trọng để đảm bảo hiệu quả khai thác tòa nhà
								của Chủ đầu tư.
							</Typography>
